 ...
 */
public class EpisodiosPerdidos extends Fragment {
    private RecyclerView mRecyclerEpisodiosPerdidos;
    private DatabaseReference mDatabaseEpisodiosPerdidos;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fragmento_episodios_perdidos, container, false);
        ...
        mDatabaseEpisodiosPerdidos = FirebaseDatabase.getInstance().getReference().child("Historias");
        mDatabaseEpisodiosPerdidos.keepSynced(true);
        ...
        mRecyclerEpisodiosPerdidos = (RecyclerView) v.findViewById(R.id.fragmento_EpisodiosPerdidos_);
        mRecyclerEpisodiosPerdidos.setHasFixedSize(true);

        mRecyclerEpisodiosPerdidos.setLayoutManager(layoutManagerTrending);

        Query queryRef = mDatabaseEpisodiosPerdidos.orderByChild("category").equalTo("EpisodiosPerdidos");

        FirebaseRecyclerAdapter<ItemFeed, RelatoViewHolderStructure> firebaseRecyclerAdapterEpisodiosPerdidos = new FirebaseRecyclerAdapter<ItemFeed, RelatoViewHolderStructure>(
                ItemFeed.class,
        ...
        mRecyclerEpisodiosPerdidos.setAdapter(firebaseRecyclerAdapterEpisodiosPerdidos);
      ...
      MenuItem item = menu.findItem(R.id.menuSearch);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                ...
                Log.v("filtrando",""+mDatabaseEpisodiosPerdidos.child(s));

                Query queryRef = mDatabaseEpisodiosPerdidos.orderByValue().equalTo(s);

                Query queryRef2 = mDatabaseEpisodiosPerdidos.orderByChild("category").equalTo("EpisodiosPerdidos");

                Log.v("filtrando",""+mDatabaseEpisodiosPerdidos);
                Log.v("filtrando",""+queryRef);
