 ...
 */
public class Fantasmas extends Fragment {
    private RecyclerView mRecyclerFantasmas;
    private DatabaseReference mDatabaseFantasmas;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fragmento_fantasmas, container, false);


        mProgress = new ProgressDialog(getContext());

        mDatabaseFantasmas = FirebaseDatabase.getInstance().getReference().child("Historias");
        mDatabaseFantasmas.keepSynced(true);
        ...
        mRecyclerFantasmas = (RecyclerView) v.findViewById(R.id.fragmento_fantasmas_);
        mRecyclerFantasmas.setHasFixedSize(true);

        mRecyclerFantasmas.setLayoutManager(layoutManagerTrending);

        Query queryRef = mDatabaseFantasmas.orderByChild("category").equalTo("Fantasmas");

        FirebaseRecyclerAdapter<ItemFeed, RelatoViewHolderStructure> firebaseRecyclerAdapterFantasmas = new FirebaseRecyclerAdapter<ItemFeed, RelatoViewHolderStructure>(
                ItemFeed.class,
